...
storiesOf("Custom Button", module)
  .add("Basic-small", () => <Button label="Click Me" size="small" onClick={action("clicked")} basic />)
  .add("Basic-medium", () => <Button label="Click Me" size="medium" onClick={action("clicked")} basic />)
  .add("Basic-Large", () => <Button label="Click Me" size="large" onClick={action("clicked")} basic/>)
  ...
  .add("Toggle-active", () => <Button label="Toggle" size="large" color="green" toggle active={true} />)
  .add("Toggle-inactive", () => <Button label="Toggle" size="large" color="green" toggle active={false}/>)
